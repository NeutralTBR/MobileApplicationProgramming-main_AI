...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    private final GeminiLibraryAccessors laccForGeminiLibraryAccessors = new GeminiLibraryAccessors(owner);
    ...
    /**
     * Group of libraries at <b>gemini</b>
     */
    public GeminiLibraryAccessors getGemini() {
        return laccForGeminiLibraryAccessors;
    }
    ...
    public static class GeminiLibraryAccessors extends SubDependencyFactory {
        private final GeminiAiLibraryAccessors laccForGeminiAiLibraryAccessors = new GeminiAiLibraryAccessors(owner);

        public GeminiLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Group of libraries at <b>gemini.ai</b>
         */
        public GeminiAiLibraryAccessors getAi() {
            return laccForGeminiAiLibraryAccessors;
        }

    }

    public static class GeminiAiLibraryAccessors extends SubDependencyFactory {

        public GeminiAiLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>api</b> with <b>com.gemini.ai:gemini-ai-api</b> coordinates and
         * with version reference <b>geminiAiApi</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getApi() {
            return create("gemini.ai.api");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>geminiAiApi</b> with value <b>1.0.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getGeminiAiApi() { return getVersion("geminiAiApi"); }
